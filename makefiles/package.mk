...
package:: stage internal-before-package before-package internal-package after-package
...
internal-before-package:: $(THEOS_PACKAGE_DIR) $(_THEOS_ESCAPED_STAGING_DIR)/DEBIAN/control
