...
_THEOS_PLATFORM_DPKG_DEB_COMPRESSION ?= Zgzip
...
internal-package::
	$(ECHO_NOTHING)COPYFILE_DISABLE=1 $(FAKEROOT) -r $(_THEOS_PLATFORM_DPKG_DEB) -b$(_THEOS_PLATFORM_DPKG_DEB_COMPRESSION) "$(THEOS_STAGING_DIR)" "$(_THEOS_DEB_PACKAGE_FILENAME)"$(ECHO_END)
