...
ifneq ($(THEOS_ROOTLESS_PREFIX), undefined)
...
# Delete everything except DEBIAN/ and /var/jb
	$(ECHO_NOTHING)find "$(THEOS_STAGING_DIR)" -mindepth 1 -maxdepth 1 ! -name DEBIAN ! -name "var" -exec rm -rf {} \;$(ECHO_END)
	$(ECHO_NOTHING)rmdir "$(THEOS_STAGING_DIR)$(THEOS_ROOTLESS_PREFIX)/var" || true$(ECHO_END)
endif
