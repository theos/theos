...
# Delete $(THEOS_PACKAGE_INSTALL_PREFIX)/var directory if it's empty
	$(ECHO_NOTHING)[ -d "$(THEOS_STAGING_DIR)$(THEOS_PACKAGE_INSTALL_PREFIX)/var" ] && rmdir "$(THEOS_STAGING_DIR)$(THEOS_PACKAGE_INSTALL_PREFIX)/var" || true$(ECHO_END)
	$(ECHO_NOTHING)[ -d "$(THEOS_STAGING_DIR)$(THEOS_PACKAGE_INSTALL_PREFIX)" ] && rmdir "$(THEOS_STAGING_DIR)$(THEOS_PACKAGE_INSTALL_PREFIX)" || true$(ECHO_END)
