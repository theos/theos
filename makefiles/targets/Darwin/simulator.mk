...
TARGET_CODESIGN ?= $(if $(_TARGET_VERSION_GE_7_0),ldid)
TARGET_CODESIGN_FLAGS ?= $(if $(_TARGET_VERSION_GE_7_0),-S)
...
NEUTRAL_ARCH = i386
>>>>>>> 6b05eac... Use pseudo-signing when targeting iOS Simulator 7.0 or later
