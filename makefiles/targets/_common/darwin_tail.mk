...
_THEOS_TARGET_CFLAGS := -isysroot "$(ISYSROOT)" $(VERSIONFLAGS) $(MODULESFLAGS) $(_THEOS_TARGET_CC_CFLAGS) $(_THEOS_TARGET_PREFIXHEADER_CFLAGS)
_THEOS_TARGET_CCFLAGS := $(_TARGET_LIBCPP_CCFLAGS) $(_THEOS_TARGET_PREFIXHEADER_CFLAGS)
...
ifeq ($(_THEOS_TARGET_USE_APPLE_LIBSWIFT),$(_THEOS_TRUE))
	_THEOS_TARGET_LDFLAGS += -L$(_THEOS_TARGET_SWIFT_LDPATH)
else
