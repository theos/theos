...
TARGET_CC ?= xcrun -sdk $(_THEOS_TARGET_PLATFORM_NAME) $(_THEOS_TARGET_CC)
TARGET_CXX ?= xcrun -sdk $(_THEOS_TARGET_PLATFORM_NAME) $(_THEOS_TARGET_CXX)
TARGET_SWIFT ?= swift
TARGET_LD ?= xcrun -sdk $(_THEOS_TARGET_PLATFORM_NAME) $(_THEOS_TARGET_CXX)
TARGET_STRIP ?= xcrun -sdk $(_THEOS_TARGET_PLATFORM_NAME) strip
