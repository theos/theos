...
ifneq ($(_SWIFT_FILE_COUNT),0)
	_THEOS_TARGET_DEFAULT_OS_DEPLOYMENT_VERSION := 7.0
...
_DEPLOY_VERSION_GE_7_0 = $(call __simplify,_DEPLOY_VERSION_GE_7_0,$(shell $(THEOS_BIN_PATH)/vercmp.pl $(_THEOS_TARGET_IPHONEOS_DEPLOYMENT_VERSION) ge 7.0))
...
ifneq ($(_SWIFT_FILE_COUNT)$(_DEPLOY_VERSION_GE_7_0),01)
before-all::
