...
_TARGET_VERSION_GE_13_0 = $(call __simplify,_TARGET_VERSION_GE_13_0,$(call __is_gte,$(_THEOS_TARGET_SDK_VERSION),13.0))
_TARGET_VERSION_GE_12_1 = $(call __simplify,_TARGET_VERSION_GE_12_1,$(call __is_gte,$(_THEOS_TARGET_SDK_VERSION),12.1))
_TARGET_VERSION_GE_12_0 = $(call __simplify,_TARGET_VERSION_GE_12_0,$(call __is_gte,$(_THEOS_TARGET_SDK_VERSION),12.0))
_TARGET_VERSION_GE_10_0 = $(call __simplify,_TARGET_VERSION_GE_10_0,$(call __is_gte,$(_THEOS_TARGET_SDK_VERSION),10.0))
_TARGET_VERSION_GE_8_4  = $(call __simplify,_TARGET_VERSION_GE_8_4,$(call __is_gte,$(_THEOS_TARGET_SDK_VERSION),8.4))
_TARGET_VERSION_GE_7_0  = $(call __simplify,_TARGET_VERSION_GE_7_0,$(call __is_gte,$(_THEOS_TARGET_SDK_VERSION),7.0))
_TARGET_VERSION_GE_6_0  = $(call __simplify,_TARGET_VERSION_GE_6_0,$(call __is_gte,$(_THEOS_TARGET_SDK_VERSION),6.0))
_TARGET_VERSION_GE_4_0  = $(call __simplify,_TARGET_VERSION_GE_4_0,$(call __is_gte,$(_THEOS_TARGET_SDK_VERSION),4.0))
_TARGET_VERSION_GE_3_0  = $(call __simplify,_TARGET_VERSION_GE_3_0,$(call __is_gte,$(_THEOS_TARGET_SDK_VERSION),3.0))
...
_DEPLOY_VERSION_GE_11_0 = $(call __simplify,_DEPLOY_VERSION_GE_11_0,$(call __is_gte,$(_THEOS_TARGET_OS_DEPLOYMENT_VERSION),11.0))
_DEPLOY_VERSION_GE_9_0  = $(call __simplify,_DEPLOY_VERSION_GE_9_0,$(call __is_gte,$(_THEOS_TARGET_OS_DEPLOYMENT_VERSION),9.0))
_DEPLOY_VERSION_GE_5_0  = $(call __simplify,_DEPLOY_VERSION_GE_5_0,$(call __is_gte,$(_THEOS_TARGET_OS_DEPLOYMENT_VERSION),5.0))
_DEPLOY_VERSION_GE_3_0  = $(call __simplify,_DEPLOY_VERSION_GE_3_0,$(call __is_gte,$(_THEOS_TARGET_OS_DEPLOYMENT_VERSION),3.0))
_DEPLOY_VERSION_LT_4_3  = $(call __simplify,_DEPLOY_VERSION_LT_4_3,$(call __is_lt,$(_THEOS_TARGET_OS_DEPLOYMENT_VERSION),4.3))
