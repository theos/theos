...
_DEPLOY_VERSION_GE_5_0 = $(shell $(THEOS_BIN_PATH)/vercmp.pl $(_THEOS_TARGET_OS_DEPLOYMENT_VERSION) ge 5.0)
_DEPLOY_VERSION_GE_3_0 = $(shell $(THEOS_BIN_PATH)/vercmp.pl $(_THEOS_TARGET_OS_DEPLOYMENT_VERSION) ge 3.0)
_DEPLOY_VERSION_LT_4_3 = $(shell $(THEOS_BIN_PATH)/vercmp.pl $(_THEOS_TARGET_OS_DEPLOYMENT_VERSION) lt 4.3)
...
ifeq ($(_TARGET_VERSION_GE_11_0),1) # >= 11.0 {
	ARCHS ?= arm64
