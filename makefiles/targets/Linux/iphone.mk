...
_THEOS_TARGET_DEFAULT_IPHONEOS_DEPLOYMENT_VERSION := 7.0
else
...
_DEPLOY_VERSION_LT_7_0 = $(call __simplify,_DEPLOY_VERSION_LT_7_0,$(shell $(THEOS_BIN_PATH)/vercmp.pl $(_THEOS_TARGET_IPHONEOS_DEPLOYMENT_VERSION) lt 7.0))
...
ifneq ($(_SWIFT_FILE_COUNT),0)
ifeq ($(_DEPLOY_VERSION_LT_7_0),1)
before-all::
	@$(PRINT_FORMAT_ERROR) "Swift requires a deployment target of iOS 7.0 or greater." >&2; exit 1
endif
endif
...
TARGET_SWIFT ?= $(PREFIX)$(_THEOS_TARGET_SWIFT)
...
_THEOS_TARGET_SWIFT_LDPATH := $(dir $(shell type -p $(TARGET_SWIFT)))../lib/swift/iphoneos
_THEOS_TARGET_SWIFT_LDFLAGS := -rpath /usr/lib/libswift/$(_THEOS_TARGET_SWIFT_VERSION)
