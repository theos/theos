...
#    1. calls __vercmp_expand_backward to pre-pad any numbers with 0s to make both numbers the same length (1 1 0 cmp 1 becomes 1 1 0 cmp 0 0 1)
...
# 4. Evaluates to the internal function __vercmp_presplit that expects the arguments to already have these transformations applied
define __vercmp
$(strip \
...
# __vercmp_presplit TEMP_VERSION_ARRAY_VARIABLE1 TEMP_VERSION_ARRAY_VARIABLE2 TEMP_RESULT_VARIABLE
...
# __vercmp_expand WORDLIST1 WORDLIST2
#
...
# __vercmp_expand_backward WORDLIST1 WORDLIST2
#
