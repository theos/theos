...
else ifneq ($(THEOS_ARCH_SCHEMA),)
ifeq ($(_THEOS_ARCH_SCHEMA),)
export _THEOS_ARCH_SCHEMA := $(shell echo "$(THEOS_ARCH_SCHEMA)" | tr 'a-z' 'A-Z')
THEOS_SCHEMA += $(_THEOS_ARCH_SCHEMA)
_THEOS_ON_SCHEMA += $(_THEOS_ARCH_SCHEMA)
endif
endif
...
_THEOS_OBJ_DIR_EXTENSION = $(if $(_THEOS_CLEANED_SCHEMA_SET),/$(_THEOS_CLEANED_SCHEMA_SET))$(if $(_THEOS_ARCH_SCHEMA),/$(_THEOS_ARCH_SCHEMA))
...
_THEOS_DISPLAY_ARCH = $(THEOS_CURRENT_ARCH)$(if $(THEOS_ARCH_SCHEMA),:$(THEOS_ARCH_SCHEMA))
endif
