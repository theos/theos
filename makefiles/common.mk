...
ifeq ($(THEOS_PACKAGE_SCHEME),)
	_THEOS_INTERNAL_SEARCHPATHS += \
		...
		$(THEOS_LIBRARY_PATH) \
		$(if $(_THEOS_TARGET_HAS_LIBRARY_PATH),$(THEOS_TARGET_LIBRARY_PATH)) \
		$(if $(_THEOS_TARGET_HAS_PRIVATE_FRAMEWORK_PATH),$(TARGET_PRIVATE_FRAMEWORK_PATH))
endif
_THEOS_INTERNAL_SEARCHPATHS += \
...
_THEOS_INTERNAL_LDFLAGS = $(foreach path,$(_THEOS_INTERNAL_SEARCHPATHS),-L$(path) -F$(path)) $(DEBUGFLAG)
...
_THEOS_INTERNAL_OBJCFLAGS = $(foreach path,$(_THEOS_INTERNAL_SEARCHPATHS),-F$(path))
