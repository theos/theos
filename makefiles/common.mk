...
ifneq ($(THEOS_TARGET_NAME),$(_THEOS_PLATFORM_DEFAULT_TARGET))
	THEOS_OBJ_DIR_NAME ?= $(_THEOS_LOCAL_DATA_DIR)/obj/$(THEOS_TARGET_NAME)$(_THEOS_OBJ_DIR_EXTENSION)
else
	THEOS_OBJ_DIR_NAME ?= $(_THEOS_LOCAL_DATA_DIR)/obj$(_THEOS_OBJ_DIR_EXTENSION)
endif
...
THEOS_STAGING_DIR_NAME ?= $(_THEOS_LOCAL_DATA_DIR)/_
