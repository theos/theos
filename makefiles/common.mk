...
__executable = $(if $(shell type "$(1)" > /dev/null 2>&1 && echo 1),$(_THEOS_TRUE),$(_THEOS_FALSE))
# Static redefinition
...
ifeq ($(_THEOS_RELATIVE_MAKE_PATH),)
...
_THEOS_INTERNAL_IFLAGS_BASE = -I$(THEOS_INCLUDE_PATH) -I$(THEOS_VENDOR_INCLUDE_PATH) -I$(THEOS_FALLBACK_INCLUDE_PATH)
