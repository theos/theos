...
_THEOS_INTERNAL_LDFLAGS += -F$(THEOS_VENDOR_LIBRARY_PATH) -framework CydiaSubstrate -rpath /Library/Frameworks/CydiaSubstrate.framework -rpath /var/jb/Library/Frameworks/CydiaSubstrate.framework
