...
_THEOS_INTERNAL_ORIONFLAGS += $(_LOCAL_ORION_DEFAULT_BACKEND)

ifeq ($(_LOCAL_ORION_DEFAULT_BACKEND),Substrate)
_THEOS_ORION_SUBSTRATE_MODULE := $(THEOS_VENDOR_SWIFT_SUPPORT_PATH)/orion/Sources/Substrate
_THEOS_INTERNAL_SWIFTFLAGS += -I$(_THEOS_ORION_SUBSTRATE_MODULE)
_THEOS_INTERNAL_CFLAGS += -I$(_THEOS_ORION_SUBSTRATE_MODULE)
endif
